...
def init_db():
    ...
    try:
        ...
        print(f"[DB] Could not connect to database during init: {e}")
        print("[DB] App will start without database initialization.")
...
def create_app():
    ...
    # Auto-initialize database tables (non-fatal if DB is unavailable)
